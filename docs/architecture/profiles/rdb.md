...
|---|---|---|---|---|
| `relational_dbserver` | `relational_dbserver` | `pacefactory/relational-dbserver:${RDB_TAG:-latest}` | [scv2_relational_dbserver](https://github.com/pacefactory/scv2_relational_dbserver) (internal) | Bridge between the deployment and a client's existing SQL database |
